...
const toLastNames = people => {
  // Solution code here...
  let fullNames = people.map((person, index) => {
...
const addValues = (arr) => {
  // Solution code here...
  let total = arr.reduce ((accumulator, number, index) => {
...
const addPurchases = (arr) => {
  // Solution code here...
  let totalPrice = arr.reduce((totalItemPrices, item, index) => {
    totalItemPrices = totalItemPrices + item.purchasePrice;
...
const countNumberOfElements = (arr) => {
  // Solution code here...
  let numofelements = arr.reduce((accumulator, value, index) => {
...
const returnNames = (arr) => {
  // Solution code here...
  let names = arr.reduce((nameArray, person, index) => {
...
const reversedString = (str) => {
  // Solution code here...
  let arr = str.split('');
  let reversedStr = arr.reduce((accumulator, currentLetter, index) => {
    accumulator = currentLetter + accumulator;
    return accumulator;
  }, '');
  return reversedStr;
};
...
const calculateAverage = (arr) => {
  // Solution code here...
  let average = arr.reduce ((accumulator, number, index) => {
    accumulator = accumulator + number;
    return accumulator;
  }, 0);
  return average;
